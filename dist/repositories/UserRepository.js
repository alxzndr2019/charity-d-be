...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.where = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.users.filter(function (user) {
                        return Object.keys(query).every(function (key) { return user[key] === query[key]; });
                    })];
            });
        });
    };
